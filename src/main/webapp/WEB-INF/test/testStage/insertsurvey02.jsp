        ...
        $(function () {
          ...
          $(function () {
            ...
            $('#inputtext').on('click', function () {
              ...
              $('.testis.0 .examinationquestion input').val('new_value_2');
              $('.testis.0 .options input[name="options"]').val('新值2');
              $('.testis.0 .options input[name="options2"]').val('新值3');


              $('.testis.1 .examinationquestion input').val('new_value_1');
              $('.testis.1 .options input[name="options"]').val('新值1');
              $('.testis.1 .options input[name="options2"]').val('新值2');


              $('.testis.2 .examinationquestion input').val('new_value_3');
              $('.testis.2 .options input[name="options"]').val('新值3');
              $('.testis.2 .options input[name="options2"]').val('新值3');
