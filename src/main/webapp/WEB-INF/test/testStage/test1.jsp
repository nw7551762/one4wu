    ...
    <body>
        ...
        <div class="main-content-wrapper d-flex clearfix">
            ...
            <div class=" cart-table-area section-padding-100">
                <div class="row"
                    style="background-color: #000000;/* width: 1219.24px; */height: 306px;/* margin-bottom: -8px; */position: inherit;top: -100px;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-2"
                                style="padding: 0%;margin: 0%;width: 250px;height: 800px;display: flex;flex-direction: column;">
                                <div
                                    style="/*border:1px black solid;*/ background-color: #f2f2f2;width: 197px;height: 264px; text-align: center;border-bottom-left-radius: 10px ;border-bottom-right-radius: 10px; margin-top: 3px;">
                                    <a href="/frontPage" class="ec-products" data-gtm="精選商品" data-sn="1680"
                                        style=""><img style="height: auto;
                      max-width: 100%;
                      width: 197px;" src="https://p2.bahamut.com.tw/B/2KU/52/f15fbff08a61fb2302432261cf1kbtg5.JPG"></a>
                                    <a href="/frontPage" class="newanime_text"
                                        style="color: rgba(255, 123, 22, 0.963);font-size: 16px;"><span>桃園籃球場特價中</span><br>廣告
                                        <font color="#F04F75">租借場地</font></a>
                                </div>
                                <div
                                    style="/*border:1px black solid;*/ background-color: #f2f2f2;width: 197px;height: 264px; text-align: center;border-bottom-left-radius: 10px ;border-bottom-right-radius: 10px; margin-top: 10px;">
                                    <a href="/frontPage" class="ec-products" data-gtm="精選商品" data-sn="1680"
                                        style=""><img style="height: auto;
                    max-width: 100%;
                    width: 197px;" src="https://p2.bahamut.com.tw/B/2KU/52/f15fbff08a61fb2302432261cf1kbtg5.JPG"></a>
                                    <a href="/frontPage" class="newanime_text"
                                        style="color: rgba(255, 123, 22, 0.963);font-size: 16px;"><span>崇浩與他論壇的五十陰影</span><br>第
                                        10
                                        集 <font color="#F04F75">今日更新</font></a>
                                </div>
                                <div
                                    style="/*border:1px black solid;*/ background-color: #f2f2f2;width: 197px;height: 264px; text-align: center;border-bottom-left-radius: 10px ;border-bottom-right-radius: 10px; margin-top: 10px;">
                                    <a href="/frontPage" class="ec-products" data-gtm="精選商品" data-sn="1680"
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    success: function (member) {
                        ...
                        nameStr = '<input type="text" id="testname" value="' + member.name + '" hidden="hidden">';
                        $('.psychoTestListPad').append(nameStr);
                ...
                //   $.ajax({
                //     type: 'post',
                //     url: "/testcenterFront.controller",
                //     datatype: 'json',
                //     async: 'false',
                //     success: function (response) {
                //       let itemsPerPage = 6;
                //       let pages = Math.ceil(response.length / itemsPerPage);
                ...
                //           let pageElements = response.slice(startIndex, endIndex);
                    ...
                    success: function (response) {
                        $.each(response, function (index, element) {
                            ...
                            if (element.shelves == "上架")
                                $('.psychoTestListPad').append(
                                    '<form action="/testgo.do" method="post" enctype="multipart/form-data"><input type="hidden" name="surveypk" value="' + element.surveypk + '"><input type="hidden" name="survey" value="' + element.survey + '"><ul data-v-20f1e346="" class="toSignup height_R2"><li data-v-20f1e346="" class="picture"><img data-v-20f1e346="" alt="" height: 180px; width: 180px; src="/ShowsurveyImgServlet.do/' + element.surveypk + '"><br></li><li data-v-20f1e346="" class="name">' + element.surveytype + '</li><li data-v-20f1e346="" class="title">' + element.survey + '</li><li data-v-20f1e346="" class="script" style="font-size: 10px;">' + element.welcometext + '</li><li data-v-20f1e346="" class="tobeMamber"><input type="button" data-v-20f1e346="" value="開始測驗" class="btn_toTest CGc toSignup" id="testgo"></li><li data-v-14420c92="" data-v-20f1e346="" class="linkPad"></li></ul></form>'
                                )
                        })
                    }
                })
