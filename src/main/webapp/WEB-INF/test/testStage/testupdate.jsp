      ...
      <div class="row">
       <div class="col-12 col-lg-8">
        <div class="checkout_details_area mt-50 clearfix">
         ...
         <!-- form Start -->
         <form action="UpdataTest.controller" method="POST" enctype="multipart/form-data" style="margin-left: 80px;">


          <div class="col-18 mb-3">
           <label for="testPk">testPk: </label>
           <input type="text" class="form-control" name="testPk" id="testPk" placeholder="" value="${update.testPk}">
          ...
          <div class="col-18 mb-3">
           ...
           <input type="text" class="form-control" name="testId" id="testId" placeholder="不輸入縣市"
            value="${update.testId}">
           <p style="font-style: italic; color:red;text-align: right">
            &nbsp;${errors.address}</p>
          </div>
          <div class="col-18 mb-3">
           ...
           <input type="text" class="form-control" name="examinationQuestion" id="examinationQuestion" placeholder=""
            value="${update.examinationQuestion}">
           <p style="font-style: italic; color:red;text-align: right">
          ...
          <div class="col-18 mb-3">
           ...
           <input type="text" class="form-control" name="field" id="field" placeholder="$" value="${update.field}">
           <p style="font-style: italic; color:red;text-align: right">
            &nbsp;${errors.price}</p>
          </div>
          <div class="col-18 mb-3">
           <label for="options">options: </label>
           <input type="text" class="form-control" name="options" id="options" placeholder="" value="${update.options}">
           <p style="font-style: italic; color:red;text-align: right">
            &nbsp;${errors.phone}</p>
          </div>
          <div class="col-18 mb-3">
           <label for="options2">options2: </label>
           <input type="text" class="form-control" name="options2" id="options2" placeholder=""
            value="${update.options2}">
           <p style="font-style: italic; color:red;text-align: right">
            &nbsp;${errors.email}</p>
          </div>
          <div class="col-18 mb-3">
           <label for="options3">options3: </label>
           <input type="text" class="form-control" name="options3" id="options3" placeholder=""
            value="${update.options3}">
           <p style="font-style: italic; color:red;text-align: right">
            &nbsp;${errors.email}</p>
          </div>
          <div class="col-18 mb-3">
           <label for="options4">options4: </label>
           <input type="text" class="form-control" name="options4" id="options4" placeholder=""
            value="${update.options4}">
           <p style="font-style: italic; color:red;text-align: right">
            &nbsp;${errors.email}</p>
          </div>
