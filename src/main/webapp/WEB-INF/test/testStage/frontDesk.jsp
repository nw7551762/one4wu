      ...
      <div class=" cart-table-area section-padding-100">
        <div class="col-12"
          ...
          <img src="/amado-master/img/test-img/your_video_file.gif"
            style="width: 800px;height: 344px ;display: flex;/* position: absolute; */left: 214px;top: 35px;margin: auto;">
        </div>
        <hr style="border-top: 3px solid rgb(0 0 0 / 14%);
          z-index: 1;
          position: inherit;
          margin-top: 0rem;">
        <div class="row">
        ...
        $.ajax({
          ...
          success: function (response) {
            $.each(response, function (index, element) {
              console.log(element)
              if (element.shelves == "上架" && element.surveytype != "問卷調查")
                $('.psychoTestListPad').append(



                  '<form action="/testgo.do" method="get" enctype="multipart/form-data"><input type="hidden" name="surveypk" value="' + element.surveypk + '"><input type="hidden" name="survey" value="' + element.survey + '"><ul data-v-20f1e346="" class="toSignup height_R2"><li data-v-20f1e346="" class="name" hidden="hidden">' + element.surveytype + '</li><li data-v-20f1e346="" class="picture"><div style="position:relative;"><img data-v-20f1e346="" alt="" height: 180px; width: 180px; src="/ShowsurveyImgServlet.do/' + element.surveypk + '"><div style="position:absolute; top:150px; left:150px;color: whitesmoke;">' + element.surveytype + '</div></div ><br></li><li data-v-20f1e346="" class="title">' + element.survey + '</li><li data-v-20f1e346="" class="script" style="font-size: 10px;">' + element.welcometext + '</li><li data-v-20f1e346="" class="tobeMamber"><input type="button" data-v-20f1e346="" value="開始測驗" class="btn_toTest CGc toSignup" id="testgo"></li><li data-v-14420c92="" data-v-20f1e346="" class="linkPad"></li></ul ></form > '
