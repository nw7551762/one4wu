                        ...
                        <ul>
                            ...
                            <div class="catagories-menu" id="showShopSideBar1">
                                <ul>
                                    ...
                                    <li><a href="/admin/showtester" style="text-shadow: 0px 0px 5px #C0C0C0;">測驗結果</a>
                                    </li>
                ...
                <div class="cart-table-area section-padding-100">
                    <div class="container-fluid">
                        <div>
                            ...
                            <form action="/admin/exportCsvcon" id="form" enctype="multipart/form-data" method="get"
                                style="width:1199px">
                                    ...
                                    <nav class="navbar navbar-expand-lg justify-content-end">
                                        ...
                                        <div class="collapse navbar-collapse" id="footerNavContent">
                                            <ul class="navbar-nav ml-auto">
                                                <li class="nav-item"><a class="nav-link" href="showAllMember">會員</a>
                                                </li>
                    ...
                    $(document).ready(function () {
                        $('#myTable').DataTable({
                            ...
                            "columns": [
                                ...
                                { "data": "inputRadio", "title": "測驗題庫", "width": "30%" },
                                { "data": "inputRadio2", "title": "問卷結果", "width": "10%" },
                            ],
