				...
				<div>
					<div class="checkout_details_area mt-50 clearfix">
						...
						<form id="myForm" action="<c:url value='/addCourse'/>"
							...
							<div class="t1">
								課程名稱:<input id="name" type="text" name="courseName">
							</div>

							<div class="t1">
								類別: <select id="category" name="category">
							...
							<div class="t1">
								教師: <input id="teacher" type="text" name="teacher">
							</div>

							<div class="t1">
								價錢:<input id="price" type="text" name="price">
							</div>

							<div class="t1">
								上課形式: <select id="type" name="courseType">
							...
							<div class="t1">
								開課日期:<input id="startdate" type="text" name="startDate">
							</div>

							<div class="t1">
								結束日期: <input id="enddate" type="text" name="endDate">
							</div>

							<div class="t1">
								開始時間: <input id="starttime" type="text" name="startTime">
							</div>

							<div class="t1">
								結束時間: <input id="endtime" type="text" name="endTime">
							</div>
							...
							<div>
								<button  id="btn" type="button">一鍵輸入</button>
							</div>
