								...
								<c:when test="${project.pjClass=='委託'}">
									<div class="row">
										<input type="hidden" name="pjID" value="${project.pjID}"
											readonly> <input type="hidden" name="pjStatus"
											value="${project.pjStatus}" readonly>
										...
										<div class="col-12 mb-3">
											<input type="text" class="form-control"
												name="pjServerLocation" value="${project.pjServerLocation}"
												required>
										</div>
							...
							<nav class="navbar navbar-expand-lg justify-content-end">
								...
								<div class="collapse navbar-collapse" id="footerNavContent">
									<ul class="navbar-nav ml-auto">
										...
										<li class="nav-item"><a class="nav-link"
											href="/admin/projects/projectBackStage/showAllEntrusBacktage/1">Project</a></li>
										<li class="nav-item"><a class="nav-link"
