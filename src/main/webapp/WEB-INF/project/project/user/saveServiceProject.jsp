			...
			<div class="row marginCenter">
				<div class="col-12 col-lg-8 marginCenter">
					<div class="checkout_details_area mt-50 clearfix">
						...
						<!--form表單從這邊開始-->
						<form action="/users/projects/saveService" method="post" enctype="multipart/form-data">
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-6 mb-3">
									<input type="text" name="pjExecutionTime"
										id="pjExecutionTime" class="form-control" placeholder="預計完成時間 幾日" required>
								</div>
								<div class="col-12 mb-3">
							...
							<div class="row">
								<div class="col-12 mb-3">
									<input type="file" class="cartButton" name="pjImg" multiple>
								</div>
							</div>
							<div class="row">
									...
									<nav class="navbar navbar-expand-lg justify-content-end">
										...
										<div class="collapse navbar-collapse" id="footerNavContent">
											<ul class="navbar-nav ml-auto">
												...
												<li class="nav-item">
													<a class="nav-link" href="/admin/projects/projectBackStage/showAllEntrusBacktage/1">Project</a>
												</li>
												<li class="nav-item">
