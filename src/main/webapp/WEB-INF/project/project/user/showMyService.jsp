	...
	<div class="main-content-wrapper d-flex clearfix">
		...
		<header class="header-area clearfix">
			...
			<div class="amado-btn-group mt-30 mb-100">
				...
				<a href="/admin/projects/showAllEntrusBacktage/1"
					class="btn amado-btn mb-15">前往後台</a>
			</div>
			<!-- Cart Menu -->
		...
		<div class="amado_product_area">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<form action="/users/projects/selectAllServiceUser/1">
								...
								<c:forEach var="pj" items="${project}">
									<tr>
										...
										<td class="cart_product_ins"><a
											href="/users/projects/projectUser/${pj.pjID}"
	...
	<script>
		...
		$('#tb').on('click', '#delete', function() {
			...
			if (yes) {
				...
				$.ajax({
					type : 'post',
					url : '/users/projects/deleteUserProject',
					data : {
						pjID : pjID,
					},
